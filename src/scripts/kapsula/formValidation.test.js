...
describe("validateSchema", () => {
  it("пропускает заполненную обязательную секцию", () => {
    const schema = capsule([{id: "style", required: true, multiple: false}]);
  ...
  it("пропускает пустую необязательную секцию", () => {
    const schema = capsule([{id: "wishes", required: false, multiple: false}]);
  ...
  it("сообщает путь до незаполненного поля, чтобы подсветить нужную секцию", () => {
    const schema = capsule([
      {id: "style", required: true, multiple: false},
      {id: "trip", required: true, multiple: false},
    ]);
